...
public class DetailsIssueForUserActivity extends AppCompatActivity {
    ...
    private TextView titleTextView, categoryTextView, descriptionInfotextView, descriptionTextView, phoneInfoTextView, phoneTextView;
    private Button goBackButton, deleteButton;
    ...
    private String category, description, phoneNumber;
